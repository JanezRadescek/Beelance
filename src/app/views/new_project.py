...
class New_project:
    ...
    def GET(self):
        ...
        return render.new_project(nav, project_form, project_buttons,  "", anti_csrf)
    ...
    def POST(self):
        ...
        anti_csrf = web.form.Form(web.form.Hidden("anti_csrf", value=data.anti_csrf))
        ...
        if data.create_project:
            ...
            for i in range(0, user_count):
                if len(data["user_name_"+str(i)]) and not models.user.get_user_id_by_name(data["user_name_"+str(i)]):    
                    return render.new_project(nav, project_form, project_buttons,  "Invalid user: " + data["user_name_"+str(i)], anti_csrf)
